...
if selected == "About":
    ...
    col1.image(Image.open("C:/Desktop/Project 2/image1.jpg"), width=500)
    with col1:
        st.subheader(
    ...
    with col2:
        st.video("C:/Desktop/Project 2/pulse-video.mp4")
...
if selected == "Home":
    col1,col2 = st.columns(2)
    with col1:
        st.image(Image.open("C:/Desktop/Project 2/image1.jpg"), width=500)
    with col2:
